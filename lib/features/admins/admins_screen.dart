    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => Form(
          ...
          child: AppDialog(
            title: 'Create Admin',
            description: 'Enter the email address of the new administrator.',
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: AppCard(
        children: [
          AppCardHeader(
            title: const AppCardTitle(text: 'Admins'),
    ...
    return PopupMenuButton<_Action>(
      ...
      itemBuilder:
          (_) => const [
            ...
            PopupMenuItem(
              value: _Action.edit,
              child: _MenuItem(icon: LucideIcons.pencil, label: 'Edit Admin'),
            ),
            PopupMenuItem(
