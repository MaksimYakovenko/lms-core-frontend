  ...
  await showDialog(
    ...
    builder: (ctx) => StatefulBuilder(
      builder: (ctx, setDialogState) => AppDialog(
        ...
        description: 'Ця дія незворотна. Групу буде видалено назавжди.',
          ...
          try {
            ...
            if (ctx.mounted) {
              ...
              AppToast.success(
                ...
                description: '${group.name} успішно видалено.',
              );
            }
          } catch (e) {
            setDialogState(() {
          ...
          children: [
            RichText(
              text: TextSpan(
                ...
                children: [
                  const TextSpan(text: 'Ви впевнені, що хочете видалити групу '),
                  TextSpan(
                    text: group.name,
