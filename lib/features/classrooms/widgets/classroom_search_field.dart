...
class ClassroomSearchField extends StatelessWidget {
  const ClassroomSearchField({super.key, required this.controller, required this.onChanged});
      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Пошук по аудиторії чи ID...',
