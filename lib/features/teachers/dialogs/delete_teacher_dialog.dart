...
Future<void> showDeleteTeacherDialog(
          ...
          try {
            ...
            if (ctx.mounted) {
              ...
              AppToast.success(
                ...
                description: '${teacher.name.isEmpty ? teacher.email : teacher.name} успішно видалено.',
              );
            }
          } catch (e) {
            setDialogState(() {
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: teacher.name.isEmpty ? teacher.email : teacher.name,
