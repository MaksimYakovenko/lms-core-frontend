...
class TeachersScreen extends StatefulWidget {
  ...
  @override
  State<TeachersScreen> createState() => _AdminsScreenState();
}

class _AdminsScreenState extends State<TeachersScreen> {
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AppDialog(
          ...
          onConfirm: () async {
            ...
            try {
              await service.deleteTeacher(admin.id);
              if (ctx.mounted) {
                Navigator.of(ctx).pop();
                onRefresh();
                AppToast.success(
                  ctx,
                  title: 'Викладача видалено',
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(text: 'Ви впевнені, що хочете видалити викладача '),
                    TextSpan(
