...
import 'package:lms_core_frontend/features/teacher_journals/dialogs/create_teacher_journal_dialog.dart';
import 'package:lms_core_frontend/features/teacher_journals/teacher_journal_service.dart';
...
class TeacherJournalScreen extends StatefulWidget {
  ...
  @override
  State<TeacherJournalScreen> createState() => _TeacherJournalsScreenState();
}

class _TeacherJournalsScreenState extends State<TeacherJournalScreen> {
  final _service = TeacherJournalService();
  final _journalsService = JournalsService();

  late Future<List<TeacherJournal>> _futureJournals;
  int _page = 1;
  ...
  void initState() {
    super.initState();
    _futureJournals = _service.getTeacherJournals();
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                AppButton(
                  ...
                  onPressed: () => createTeacherJournalDialog(
                    context,
            ...
            FutureBuilder<List<TeacherJournal>>(
