...
Future<void> createTeacherJournalDialog(
...
class _CreateTeacherJournalDialog extends StatefulWidget {
  const _CreateTeacherJournalDialog({
  ...
  @override
  State<_CreateTeacherJournalDialog> createState() => _CreateTeacherJournalDialogState();
}

class _CreateTeacherJournalDialogState extends State<_CreateTeacherJournalDialog> {
  ...
  Future<void> _loadGroups() async {
    try {
      final groups = await _groupsService.getTeacherGroups();
      if (mounted) {
        setState(() {
          _groups = groups;
  ...
  Future<void> _loadSubjects() async {
    try {
      final subjects = await _subjectsService.getTeacherSubject();
      if (mounted) {
        setState(() {
          _subjects = subjects;
